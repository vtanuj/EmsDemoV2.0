...
//			parentStage.show();
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        print.setGraphic(JavaFXUtils.getGraphic("FontAwesome", FontAwesome.Glyph.PRINT, 16, Color.DARKGREY));
        
        save.setGraphic(JavaFXUtils.getGraphic("FontAwesome", FontAwesome.Glyph.SAVE, 16, Color.DARKGREY));
